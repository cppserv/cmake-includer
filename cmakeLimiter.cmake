...
if (NOT CMAKE_LIMITER_NOREDIFINE)
    ...
    function(cmakelimiter_custom_targets onoff)
        if (NOT NO_ADD_CUSTOM)
            set(NO_ADD_CUSTOM "0" CACHE STRING "how many calls to cmakelimiter_compile_executables have been done" FORCE)
        endif()
        ...
        if(new_variable LESS 1)
            ...
            set(NO_ADD_CUSTOM ${new_variable} CACHE STRING "how many calls to cmakelimiter_compile_executables have been done" FORCE)
        endif()
    ...
    function(cmakelimiter_messages onoff)
        if (NOT MESSAGE_QUIET)
            set(MESSAGE_QUIET "0" CACHE STRING "how many calls to cmakelimiter_compile_executables have been done" FORCE)
        endif()
        ...
        if(new_variable LESS 1)
            ...
            set(MESSAGE_QUIET ${new_variable} CACHE STRING "how many calls to cmakelimiter_compile_executables have been done" FORCE)
        endif()
